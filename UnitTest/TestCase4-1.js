...
const url       = apiHost + "api/v1.0/GovSimpleAuth/SimpleAuthRequest";
...
const options   = {
    ...
    json: {
        "PrivateAuthType"       : "4",
        "UserName"              : aesEncrypt(aesKey, aesIv, "홍길동"),
        "BirthDate"             : aesEncrypt(aesKey, aesIv, "19880101"),
        "UserCellphoneNumber"   : aesEncrypt(aesKey, aesIv, "01012341234"),
    },
};
