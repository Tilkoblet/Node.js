...
// API URL 설정
// HELP: https://tilko.net/Help/Api/POST-api-apiVersion-Credit4u-CheckedSelfAuthCode
const url       = apiHost + "api/v1.0/Credit4u/CheckedSelfAuthCode";
...
const options   = {
    ...
    json: {
        ...
        "UserCellphone": aesEncrypt(aesKey, aesIv, "__VALUE__"),
        "CaptchaCode": "__VALUE__"
    },
};
