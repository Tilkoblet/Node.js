...
// API URL 설정
// HELP: https://tilko.net/Help/Api/POST-api-apiVersion-Credit4u-JoinSite
const url       = apiHost + "api/v1.0/Credit4u/JoinSite";
...
const options   = {
    ...
    json: {
        "EmailCode": aesEncrypt(aesKey, aesIv, "__VALUE__"),
        "UserEmail": aesEncrypt(aesKey, aesIv, "__VALUE__"),
