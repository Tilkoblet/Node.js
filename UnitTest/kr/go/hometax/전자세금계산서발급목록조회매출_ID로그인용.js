...
// API URL 설정
// HELP: https://tilko.net/Help/Api/POST-api-apiVersion-HometaxIdLogin-UTEETBDA01-MaeChul
const url       = apiHost + "api/v1.0/HometaxIdLogin/UTEETBDA01/MaeChul";
...
const options   = {
    ...
    json: {
        ...
        "SecretCard": aesEncrypt(aesKey, aesIv, "__VALUE__")
    },
};
