...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-HometaxGeneral-UTERNAAZ110-JongHabSoDeugSe-SinGo
    ...
    try {
        ...
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/hometaxgeneral/uternaaz110/jonghabsodeugse/singo");
        ...
        _rest.AddBody("BusinessNumber", _publicCert, true);                   // [암호화] 검색 할 사업자등록번호 또는 주민등록번호(xxxxxxxxxx 또는 xxxxxxxxxxxxx / Base64 인코딩) 공백일 검색기간은 30일, 아닐경우 검색기간은 365일
