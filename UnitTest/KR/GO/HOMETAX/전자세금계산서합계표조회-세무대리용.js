...
(function (_Tilko) {
    ...
    try {
        ...
        _rest.AddBody("Year", "", false);                               // 검색년도(yyyy) 공백일 경우 검색 기준 해
        _rest.AddBody("StartMonth", "", false);                         // 검색 시작 월(MM) 공백일 경우 검색 기준 월
        _rest.AddBody("EndMonth", "", false);                           // 검색 종료 월(MM) 공백일 경우 검색 기준 월
