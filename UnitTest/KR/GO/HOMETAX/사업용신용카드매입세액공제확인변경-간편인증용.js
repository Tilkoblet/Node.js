...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-HometaxSimpleAuth-UTECRCB023
    
    try {
        let _rest = new Rest(Constant.ApiKey);
        _rest.Init();

        // 홈택스의 사업용신용카드 매입세액 공제 확인 변경 endPoint 설정
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/HometaxSimpleAuth/UTECRCB023");
