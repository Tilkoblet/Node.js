...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-HometaxIdLogin-UTERNAAZ111-WonCheonSe-NapBu
    ...
    try {
        ...
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/hometaxidlogin/uternaaz111/woncheonse/napbu");
        ...
        _rest.AddBody("StartDate", "", false);                      // 검색종료일(yyyyMMdd) 공백일 경우 기본값을 API에서 셋팅
