...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-HometaxGeneral-UTERNAAZ110-BuGaGaChiSe-NapBu
    ...
    try {
        ...
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/hometaxgeneral/uternaaz110/bugagachise/napbu");
