...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-HometaxIdLogin-UTERNAAZ110-BuGaGaChiSe-SinGo
    ...
    try {
        ...
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/hometaxidlogin/uternaaz110/bugagachise/singo");
