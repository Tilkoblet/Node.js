...
(function (_Tilko) {
    ...
    try {
        ...
        // 건강보험공단EDI의 부과내역조회가입자 조회 endPoint 설정
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/nhisedi/bmbb_020");
        ...
        _rest.AddBody("DocId", "", false);                              // DocId
        _rest.AddBody("GojiYyyymm", "", false);                         // 고지년월(yyyyMM)
        _rest.AddBody("GojiChasu", "", false);                          // 고지차수
        _rest.AddBody("NationFinanceCd", "", false);                    // NationFinanceCd
