...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-NhisEdi-WETC_100
    
    try {
        let _rest = new Rest(Constant.ApiKey);
        _rest.Init();

        // 건강보험공단EDI의 보낸문서리스트 조회 endPoint 설정
        _rest.SetEndPointUrl(Constant.ApiHost + "api/v1.0/nhisedi/WETC_100");
        ...
        _rest.AddBody("FromDt", "", false);                             // 조회기간시작(yyyyMMdd)
        _rest.AddBody("ToDt", "", false);                               // 조회기간종료(yyyyMMdd)
