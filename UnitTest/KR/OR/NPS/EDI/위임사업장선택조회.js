...
(function (_Tilko) {
    ...
    try {
        ...
        // 국민연금EDI의 위임사업장 선택 조회 endPoint 설정
        ...
        _rest.AddBody("FindData", "", false);                           // 위임사업장이름(위임사업장 리스트 조회 후 받은 EdiBsnsBrkgWkplNm 값)
        _rest.AddBody("WediUsrId", "", false);                          // 위임사업장 리스트 조회 후 받은 WediUsrId 값
