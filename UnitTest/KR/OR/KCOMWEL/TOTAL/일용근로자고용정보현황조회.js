...
(function (_Tilko) {
    ...
    // API 상세설명 URL
    // https://tilko.net/Help/Api/POST-api-apiVersion-Kcomwel-SelectIlyongGeunrojaInfoJohoe
    
    try {
        let _rest = new Rest(Constant.ApiKey);
        _rest.Init();

        // 고용산재토탈의 일용근로자 고용정보 현황 조회 endPoint 설정
        ...
        _rest.AddBody("DaesangYYFrom", "", false);                           // 대상연도_시작(yyyy)
        _rest.AddBody("DaesangYYTo", "", false);                             // 대상연도_종료(yyyy)
